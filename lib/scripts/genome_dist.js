...
function calculateDistances() {
    ...
    for (roomKey in spacesDict) {
        ...
        for (feature in roomFeatures) {
            ...
            if (feature != "AttractionThresh" && feature != "AvoidanceThresh") {
        ...
        //sort results per room by feature score ascending
        ...
        if (bestPlayer[1] <= attractionThresh) {
            outlet(0, roomKey, "attract to " + bestPlayer[0] + " " + bestPlayer[1]);
        } 
