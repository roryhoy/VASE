...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1115.0, 671.0, 46.0, 20.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1318.0, 695.0, 67.0, 20.0 ],
					"text" : "loadmess set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1280.0, 803.0, 56.0, 20.0 ],
					"text" : "route done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1227.5, 816.0, 29.5, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 704.0, 236.0, 76.0, 18.0 ],
					"text" : "[spawn_bang]",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 787.5, 233.0, 24.0, 24.0 ],
					"varname" : "spawn_bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 950.5, 113.0, 150.0, 18.0 ],
					"text" : "after spawning and connections"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 980.0, 133.0, 91.0, 20.0 ],
					"text" : "r #0_post_script"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 689.0, 3.0, 91.0, 20.0 ],
					"text" : "r #0_post_script"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1486.0, 1789.0, 228.0, 20.0 ],
					"text" : "script connect source_aed_mess 0 spat_viewer 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1470.0, 1749.0, 220.0, 20.0 ],
					"text" : "script connect dist_mess_r 0 dist_mess_cycle 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 693.5, 83.0, 68.0, 18.0 ],
					"text" : "[title_mess]",
					"textcolor" : [ 0.0, 0.486274509803922, 0.556862745098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 756.5, 54.0, 50.0, 20.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 474.0, 340.0, 96.0, 18.0 ],
					"text" : "[source_aed_mess]",
					"textcolor" : [ 0.0, 0.486274509803922, 0.556862745098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1933.0, 1479.0, 123.5, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1966.0, 1526.0, 157.0, 208.0 ],
					"text" : "source_rec to source_unpack\nsource_unpack to filter_n (0)\ndist_mess_r to dist_mess_cycle\ndist_mess_cycle to filter_n (1)\nfilter_n (0) to source_pack (n)\nsource_aed_mess to spat_viewer\ntitle_mess to spat_viewer\nview_mess to spat_viewer\nsource_pack to hoa_encoder\nnorm_mess to hoa_encoder\nnorm_mess to hoa_decoder\nspat_viewer to hoa_encoder\nspat_viewer to hoa_decoder\ntype_mess to hoa_decoder\nmeth_mess to hoa_decoder\nphantom_mess to hoa_decoder\nhoa_encoder to hoa_decoder\nhoa_decoder to out_gain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 962.5, 50.5, 68.0, 18.0 ],
					"text" : "[view_mess]",
					"textcolor" : [ 0.0, 0.486274509803922, 0.556862745098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 934.0, 456.5, 68.0, 18.0 ],
					"text" : "[type_mess]",
					"textcolor" : [ 0.0, 0.486274509803922, 0.556862745098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 831.0, 401.5, 68.0, 18.0 ],
					"text" : "[norm_mess]",
					"textcolor" : [ 0.0, 0.486274509803922, 0.556862745098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"fontsize" : 16.763774901795738,
					"id" : "obj-140",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1545.0, 941.0, 155.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "sprintf script newdefault dist_mess_cycle 447 227 cycle %i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1616.0, 1000.0, 122.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1756.0, 976.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1756.0, 1009.0, 55.0, 20.0 ],
					"text" : "s kill-filters"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 198.0, 68.0, 18.0 ],
					"text" : "[dist_mess_r]",
					"textcolor" : [ 0.0, 0.486274509803922, 0.556862745098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 820.0, 55.0, 95.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 820.0, 29.0, 117.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1029.5, 17.5, 45.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 787.5, 3.0, 65.0, 20.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 756.5, 82.0, 158.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1029.5, 49.5, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1589.0, 1036.0, 43.0, 20.0 ],
					"text" : "dispose"
				}
...
, 			{
				"box" : 				{
					...
					"outlinecolor" : [ 1.0, 0.0, 0.0, 1.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1589.0, 1003.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1589.0, 974.0, 67.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1115.0, 644.0, 50.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 572.0, 308.0, 29.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 577.0, 247.0, 57.0, 20.0 ],
					"text" : "unpack 0 s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 633.0, 283.0, 60.0, 20.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 635.0, 308.0, 52.0, 20.0 ],
					"text" : "unpack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 572.0, 375.0, 28.0, 20.0 ],
					"text" : "print"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 183.0, 49.0, 20.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 45.0, 280.0, 70.0, 20.0 ],
									"text" : "funnel 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 45.0, 245.0, 40.0, 20.0 ],
									"text" : "cycle 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 107.0, 246.0, 107.0, 18.0 ],
									"text" : "script for source count",
									"textcolor" : [ 1.0, 0.0, 0.431372549019608, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 156.0, 52.0, 20.0 ],
									"text" : "zl.group 2"
								}
...
,
					"patching_rect" : [ 577.0, 223.0, 67.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 2.0, 185.0, 91.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 578.0, 11.0, 65.0, 20.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 577.0, 196.0, 19.0, 20.0 ],
					"text" : "r"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 577.0, 165.0, 134.0, 20.0 ],
					"text" : "sprintf set listener-angles-%i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 166.0, 95.0, 18.0 ],
					"text" : "distance updates in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 165.0, 120.0, 20.0 ],
					"text" : "sprintf set listener-dist-%i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 197.0, 19.0, 20.0 ],
					"text" : "r",
					"varname" : "dist_mess_r"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 596.0, 71.0, 77.0, 18.0 ],
					"text" : "listener number"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 578.0, 43.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 596.0, 420.0, 184.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 972.0, 396.0, 60.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 972.0, 431.0, 84.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 