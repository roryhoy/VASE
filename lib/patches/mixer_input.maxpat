{
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "fontsize": 8.0,
                    "hint": "adc~ will take the input audio from your chosen input interface. receive~ will get a signal from another Max patch using [send~ to_vase_16]",
                    "id": "obj-12",
                    "maxclass": "live.text",
                    "numinlets": 1,
                    "numoutlets": 2,
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 58.0, 365.0, 122.0, 22.0 ],
        ...
        "parameters": {
            "obj-12": [ "live.text[31]", "live.text", 0 ],
            "obj-174": [ "live.gain~[113]", "#1:", 0 ],
