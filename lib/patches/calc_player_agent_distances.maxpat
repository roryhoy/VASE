{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 1172.0, 311.0, 1134.0, 916.0 ],
        "boxes": [
            {
                "box": {
                    "id": "obj-14",
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ 87.0, 547.0, 29.5, 22.0 ],
                    "text": "> 0"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 171.0, 448.0, 132.0, 25.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 100.0, 586.0, 52.0, 22.0 ],
                    "text": "gate 1 0"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 856.0, 365.0, 135.0, 22.0 ],
                    "text": "prepend player_rotation"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 856.0, 290.0, 81.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 485.0, 835.0, 152.0, 22.0 ],
                    "saved_object_attributes": {
                        "embed": 0,
                        "precision": 6
                    },
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 291.0, 835.0, 157.0, 22.0 ],
                    "saved_object_attributes": {
                        "embed": 0,
                        "precision": 6
                    },
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 136.5, 714.0, 24.0, 24.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 136.5, 749.0, 52.0, 22.0 ],
                    "text": "gate 1 0"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 136.5, 792.0, 32.0, 22.0 ],
                    "text": "print"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 98.0, 835.0, 153.0, 22.0 ],
                    "saved_object_attributes": {
                        "embed": 0,
                        "precision": 6
                    },
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 305.0, 682.0, 69.0, 22.0 ],
                    "text": "print debug"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 793.0, 461.0, 50.0, 22.0 ],
                    "text": "compile"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 793.0, 432.0, 58.0, 22.0 ],
                    "text": "loadbang"
                }
            },
            {
